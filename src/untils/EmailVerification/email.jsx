 ...
 //Отправка письма на почту и сообщения (снебкары)
  ...
  return (
    <div className={classes.EmailBox}>
      ...
      <p className={classes.text}>Чтобы продолжить передите по ссылке в письме.</p>
      <button className={classes.button} onClick={Email} disabled={props.loading}>Отправить письмо</button>
      </div>
    </div>
  );
};
